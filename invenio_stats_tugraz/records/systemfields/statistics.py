...
from ..statistics import LomStatistics, Marc21Statistics


class TugrazRecordStatisticsField(RecordStatisticsField):
...
class Marc21RecordStatisticsField(TugrazRecordStatisticsField):
    """Marc21 field for lazy fetching record statistics."""

    api = Marc21Statistics


class LomRecordStatisticsField(TugrazRecordStatisticsField):
    """Lom field for lazy fetching record statistics."""
